...
const MoreSkills = () => {
  ...
  return (
    <div className="mt-3">
      <div id="exp">
        <div>
          <span className="px-3 bg-orange-100 rounded-md mr-3"></span> Beginner
        </div>
        <div>
          <span className="px-3 bg-orange-300 rounded-md mr-3"></span>{" "}
          Experienced
        </div>
        <div>
...
303 302 302 303 303 -345 0 -345 0 -303 -303z"
      ...
      <div className="flex mt-3 text-center flex-wrap">
        ...
        <span className="hover:text-orange-300 text-gray-300 fill-gray-300 hover:fill-orange-300 mr-3">
          ...
          <p className="mt-2 text-smm">NGINX</p>
        </span>
        <span className="hover:text-orange-300 text-gray-300 fill-gray-300 hover:fill-orange-300 mr-3">
          <svg
            width="55px"
          ...
          <p className="mt-2 text-smm">APACHE</p>
        </span>
      </div>
      <h3 className="text-2xl border-b-2 pb-2 border-purple-500 w-14 whitespace-nowrap">
        Game
      ...
      <div className="flex mt-3 text-center flex-wrap">
        ...
        <span className="hover:text-orange-100 text-gray-300 fill-gray-300 hover:fill-orange-100 mr-3">
          ...
          <p className="mt-2 text-smm">GODOT</p>
        </span>
      </div>
      ...
      <div className="flex mt-3 text-center flex-wrap">
        <span className="hover:text-orange-300 text-gray-300 mr-3">
          ...
          <p className="mt-2 text-smm">GITHUB ACTION</p>
        </span>
        <span className="hover:text-orange-300 text-gray-300 mr-3">
          <FontAwesomeIcon size="3x" icon={["fab", "gitlab"]} />
          <p className="mt-2 text-smm">GITLAB CI</p>
        </span>
      </div>
      <h3 className="text-2xl border-b-2 pb-2 border-purple-500 w-14 whitespace-nowrap">
        Testing & Security
      ...
      <div className="flex mt-3 text-center flex-wrap">
        <span className="hover:text-orange-300 text-gray-300 fill-gray-300 hover:fill-orange-300 mr-3">
          ...
          <p className="mt-2 text-smm uppercase">JEST</p>
        </span>
        <span className="hover:text-orange-300 text-gray-300 fill-gray-300 hover:fill-orange-300 mr-3">
          <svg
            width="55px"
            ...
            <g>
              ...
              <g transform="translate(50.181225, 45.198924)">
                ...
                <path
                  ...
                  fill="#2e253a"
                ></path>
                <path d="M60.2859351,100.077962 C58.494258,100.077962 57.0865117,98.670216 57.0865117,96.878539 C57.0865117,95.9827004 57.4704425,95.2148388 57.9823502,94.5749541 L65.7889432,86.7683612 C66.3008509,86.2564534 67.0687125,86.2564534 67.5806203,86.7683612 L75.6431671,94.830908 C76.0270979,95.2148388 76.1550749,95.5987696 76.0270979,96.1106774 C75.899121,96.4946082 75.5151902,96.878539 75.0032825,97.0065159 L60.9258197,100.077962 C60.6698659,100.077962 60.413912,100.077962 60.2859351,100.077962 L60.2859351,100.077962 Z M66.6847817,89.4558768 L59.7740273,96.3666312 C59.5180734,96.6225851 59.5180734,96.878539 59.6460504,97.1344928 C59.7740273,97.3904467 60.0299812,97.5184236 60.413912,97.5184236 L72.1877899,94.9588849 L66.6847817,89.4558768 Z"></path>
                <path d="M153.069212,19.7084478 C152.813258,18.9405862 151.91742,18.5566554 151.149558,18.8126093 C150.381697,19.0685632 149.997766,19.9644017 150.25372,20.7322633 C150.25372,20.8602402 150.381697,20.9882172 150.381697,21.1161941 C151.149558,22.6519173 150.893604,24.5715713 149.869789,25.9793176 C149.357881,26.6192023 149.485858,27.5150408 149.997766,28.0269485 C150.63765,28.5388563 151.533489,28.4108793 152.045397,27.7709947 C153.965051,25.3394329 154.348981,22.2679865 153.069212,19.7084478 L153.069212,19.7084478 Z"></path>
              </g>
            </g>
          </svg>

          <p className="mt-2 text-smm uppercase">POSTMAN</p>
        </span>
        <span className="hover:text-orange-300 text-gray-300 fill-gray-300 hover:fill-orange-300 mr-3">
          <svg
            version="1.0"
          ...
          >
            <g
              ...
              stroke="none"
            >
              <path d="M1009 2130 c-618 -77 -1016 -681 -843 -1276 46 -160 131 -303 253 -425 343 -343 868 -391 1276 -116 77 52 200 175 252 252 60 90 110 194 137 289 163 561 -183 1140 -754 1261 -87 18 -239 26 -321 15z m356 -180 c227 -72 411 -227 515 -435 66 -131 81 -194 87 -348 5 -107 2 -142 -16 -221 -74 -320 -334 -575 -653 -640 -450 -93 -895 193 -999 640 -18 79 -21 114 -16 221 6 154 21 217 87 348 114 228 326 394 574 451 95 21 331 13 421 -16z" />
              <path d="M1498 1713 c18 -34 20 -47 11 -72 -13 -35 -15 -37 -35 -16 -22 22 -31 19 -76 -25 -37 -37 -40 -44 -35 -80 l5 -40 -44 0 c-39 0 -45 3 -61 33 -11 20 -17 51 -16 82 l2 50 -11 -49 c-8 -35 -7 -59 0 -84 14 -43 12 -46 -16 -27 -11 9 -29 40 -38 70 -10 30 -19 53 -21 51 -6 -6 19 -110 29 -123 24 -30 -16 -10 -59 30 -25 23 -41 33 -35 22 22 -38 49 -63 93 -85 24 -13 39 -25 32 -27 -7 -2 -67 5 -135 16 -68 11 -163 26 -213 33 -101 13 -420 17 -449 5 -18 -7 -18 -9 4 -32 32 -34 166 -112 235 -136 31 -11 91 -22 134 -26 72 -5 80 -4 131 25 43 23 72 31 135 36 44 4 98 9 120 12 37 5 41 3 51 -23 10 -28 10 -28 -28 -25 -28 3 -50 -3 -85 -23 -66 -40 -193 -168 -246 -250 -46 -73 -161 -295 -152 -295 3 0 51 23 108 51 152 76 253 147 346 244 88 92 127 159 116 202 -5 22 -3 24 17 18 13 -4 25 -9 27 -11 2 -1 -2 -58 -9 -126 -10 -104 -17 -131 -41 -174 -33 -59 -36 -96 -14 -196 23 -112 155 -341 181 -315 14 14 17 253 5 385 -7 70 -24 194 -37 276 -14 81 -23 150 -20 153 2 3 14 -14 26 -38 22 -42 47 -69 85 -91 11 -6 1 10 -22 35 -40 44 -60 83 -30 60 13 -11 97 -33 119 -32 7 0 -12 9 -42 20 -50 18 -80 40 -80 61 0 4 12 3 26 -2 31 -12 92 -12 119 1 14 7 6 8 -30 4 -72 -7 -110 19 -111 77 l-1 43 43 -3 c39 -4 46 0 79 35 39 42 42 55 20 77 -21 21 -19 24 21 32 25 4 48 1 73 -10 l36 -16 -24 20 c-25 22 -80 27 -112 9 -17 -8 -26 -4 -58 28 -38 37 -38 38 -24 71 16 38 5 90 -24 114 -12 9 -10 2 5 -29z" />
              <path d="M1770 300 c0 -5 9 -10 20 -10 18 0 20 -7 20 -55 0 -30 5 -55 10 -55 6 0 10 25 10 55 0 48 2 55 20 55 11 0 20 5 20 10 0 6 -22 10 -50 10 -27 0 -50 -4 -50 -10z" />
              <path d="M1890 245 c0 -75 17 -88 22 -17 l4 47 13 -47 c17 -59 35 -61 48 -5 l11 42 1 -42 c1 -31 5 -43 16 -43 12 0 15 14 15 66 0 61 -1 65 -22 62 -15 -2 -25 -14 -33 -43 l-12 -40 -12 43 c-9 31 -17 42 -31 42 -18 0 -20 -7 -20 -65z" />
            </g>
          </svg>

          <p className="mt-2 text-smm uppercase">owasp top 10</p>
          <p className="text-smm uppercase -mt-3">2017 - 2021</p>
        </span>
      </div>
      <h3 className="text-2xl border-b-2 pb-2 border-purple-500 w-14 whitespace-nowrap">
        Others
